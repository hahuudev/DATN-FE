...
const navListMenuItems = [
    {
        ...
        title: (
            <div className="flex items-center gap-1">
                Bóng Đá <Chip size="sm" color="green" variant="ghost" value="Tuyển thành viên!" className="capitalize" />
            </div>
        ),
        src: '/pitch',
...
function NavListMenu() {
    ...
    const renderItems = navListMenuItems.map(({ icon, title, description, color, src }, key) => (
        <Link to={src} key={key}>
...
function NavList() {
    return (
        <List className="mt-4 mb-6 p-0 lg:mt-0 lg:mb-0 lg:flex-row lg:p-1">
            <NavListMenu />
            <Typography as="a" href="timdoi" variant="small" color="blue-gray" className="font-normal">
