...
const Pitch = () => {
    ...
    return (
        <div>
            <div className="banner-pitchPage relative ">
                {/* banner cấc thứ */}
                <div className="video">
                ...
                <div className="absolute book-banner  left-0 right-0 bottom-[-90px]">
                    ...
                    <div className="flex  gap-3 items-center flex-wrap  min-w-0 mx-auto justify-center w-full max-w-screen-2xl">
                        ...
                        <Select mode="tags" style={{ width: '15%' }} placeholder="Môn thể thao" onChange={handleChange}>
                        ...
                        <Button className="bg-red-500 hover:bg-red-700 hover:text-white text-white" icon={<SearchOutlined />}>
                            Search
                        </Button>
                    </div>
                </div>
                            ...
                            <Link to="detail">
                                ...
                                <div className="text-item-pitch">
                                    ...
                                    <p className="flex justify-between">
                                        ...
                                        <span className="text-[23px] text-[#ffb932] text-bold">150.000 - 850.000</span>
                                    </p>
                                </div>
                            </Link>
                        </div>
            ...
            <div className="hot-pitch mx-auto max-w-screen-2xl xl px-[30px]">
                ...
                <Swiper spaceBetween={80} slidesPerView={3} onSlideChange={() => console.log('slide change')} onSwiper={(swiper) => console.log(swiper)}>
                    <SwiperSlide>
